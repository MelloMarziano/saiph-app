...
class _Item {
  ...
  _Item(this.name, this.max) : value = 0, comment = TextEditingController();
}
...
class _ImpactoF {
  ...
  int valor;
  final TextEditingController comment;
  _ImpactoF(this.index) : valor = 0, comment = TextEditingController();
}
...
class _PrecisionF {
  ...
  int valor;
  final TextEditingController comment;
  _PrecisionF(this.index) : valor = 0, comment = TextEditingController();
}
...
class _GradoM {
  ...
  int valor;
  final TextEditingController comment;
  _GradoM(this.index) : valor = 0, comment = TextEditingController();
}
...
class _PrecisionM {
  ...
  int valor;
  final TextEditingController comment;
  _PrecisionM(this.index) : valor = 0, comment = TextEditingController();
}
...
class _GradoS {
  ...
  int valor;
  final TextEditingController comment;
  _GradoS(this.index) : valor = 0, comment = TextEditingController();
}
...
class _PrecisionS {
  ...
  int valor;
  final TextEditingController comment;
  _PrecisionS(this.index) : valor = 0, comment = TextEditingController();
}
...
class _ImpactoT {
  ...
  int valor;
  final TextEditingController comment;
  _ImpactoT(this.index) : valor = 0, comment = TextEditingController();
}
...
class _PrecisionT {
  ...
  int valor;
  final TextEditingController comment;
  _PrecisionT(this.index) : valor = 0, comment = TextEditingController();
}
...
class _SyncT {
  ...
  int valor;
  final TextEditingController comment;
  _SyncT(this.index) : valor = 0, comment = TextEditingController();
}
...
class _EvaluacionMarchaScreenState extends State<EvaluacionMarchaScreen> {
  ...
  Widget build(BuildContext context) {
    final Peloton? p = Get.arguments is Peloton
        ? Get.arguments as Peloton
        : null;
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Estilo: ${_peloton!.tipoMarcha}',
                          style: const TextStyle(color: Colors.black54),
                        ),
                        const SizedBox(height: 2),
                        Text(
                          'Miembros: ${_peloton!.cantidadMiembros}',
                          style: const TextStyle(color: Colors.black54),
                        ),
                      ],
                    ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (_exhibicionesFS.isNotEmpty)
                          _accordion(
                            'Pliegue o Repliegue/Deformaciones • 12 pts',
                            _expandFS,
                            () {
                              setState(() {
                                _expandFS = !_expandFS;
                            ...
                            _exhibicionesFS
                                .map((e) => _exhibicionCard(e))
                                .toList(),
                          ),
                        if (_exhibicionesMS.isNotEmpty)
                          _accordion(
                            'Pliegue o Repliegue/Deformaciones • 18 pts',
                            _expandMS,
                            () {
                              setState(() {
                                _expandMS = !_expandMS;
  ...
  Future<void> _performSave() async {
    ...
    try {
      final box = GetStorage();
      final user = box.read('user');
      final evaluadorNombre =
          (user is Map && (user['nombre'] ?? '').toString().isNotEmpty)
          ? (user['nombre'] as String)
          : '';
      final evaluadorEmail =
          (user is Map && (user['email'] ?? '').toString().isNotEmpty)
      ...
      docId =
          '${_peloton!.id}_${evaluadorEmail.isNotEmpty ? evaluadorEmail : evaluadorNombre}';
      ...
      evalData = {
        ...
        'exhibiciones': [
          ...
          ..._innovacionesS.map(
            (e) => {
              ...
              'maxPorExhibicion': 4,
              'comment': e.comment.text.trim(),
              'commentOriginalidadBordon': e.commentOriginalidadBordon.text
                  .trim(),
              'commentIntervalos': e.commentIntervalos.text.trim(),
            },
          ),
          ...
          ..._gradoF.map(
            (e) => {
              ...
              'commentGradoDificultadDeformacion': e.commentDeformacion.text
                  .trim(),
            },
          ),
          ..._gradoM.map(
        ...
        'totalParcial':
            _items.fold<int>(0, (a, b) => a + b.value) +
            _exhibicionesFS.fold<int>(
              0,
              (a, b) => a + b.pliegue + b.deformaciones,
            ) +
            _exhibicionesMS.fold<int>(
              0,
              (a, b) => a + b.pliegue + b.creatividad,
            ) +
            _innovacionesF.fold<int>(
              0,
              (a, b) => a + b.originalidad + b.ejecucion + b.composicion,
            ) +
            _innovacionesM.fold<int>(
              0,
              (a, b) =>
                  a +
                  b.originalidad +
            ...
            _innovacionesS.fold<int>(
              0,
              (a, b) => a + b.originalidadBordon + b.intervalos,
            ) +
            _innovacionesT.fold<int>(
              0,
              (a, b) => a + b.originalidad + b.ejecucion,
            ) +
            _gradoF.fold<int>(0, (a, b) => a + b.tiempos + b.deformacion) +
            _gradoM.fold<int>(0, (a, b) => a + b.valor) +
            _gradoS.fold<int>(0, (a, b) => a + b.valor) +
            _gradoT.fold<int>(0, (a, b) => a + b.tiempos + b.deformacion) +
            _impactoF.fold<int>(0, (a, b) => a + b.valor) +
            _impactoT.fold<int>(0, (a, b) => a + b.valor) +
            _precisionF.fold<int>(0, (a, b) => a + b.valor) +
            _precisionM.fold<int>(0, (a, b) => a + b.valor) +
            _precisionS.fold<int>(0, (a, b) => a + b.valor) +
            _precisionT.fold<int>(0, (a, b) => a + b.valor) +
            _syncT.fold<int>(0, (a, b) => a + b.valor) -
            (_faltasGenerales.where((f) => f.selected).length * 5) -
            (_faltasEstiloFancy.where((f) => f.selected).length * 2) -
            (_faltasEstiloMilitary.where((f) => f.selected).length * 2) -
            (_faltasEstiloSilent.where((f) => f.selected).length * 2) -
            (_faltasEstiloSoundtrack.where((f) => f.selected).length * 2),
        'faltasGenerales': _faltasGenerales
            .where((f) => f.selected)
            .map((f) => f.name)
            .toList(),
        'faltasEstiloFancy': _faltasEstiloFancy
            .where((f) => f.selected)
            .map((f) => f.name)
            .toList(),
        'faltasEstiloMilitary': _faltasEstiloMilitary
            .where((f) => f.selected)
            .map((f) => f.name)
            .toList(),
        'faltasEstiloSilent': _faltasEstiloSilent
            .where((f) => f.selected)
            .map((f) => f.name)
            .toList(),
        'faltasEstiloSoundtrack': _faltasEstiloSoundtrack
            .where((f) => f.selected)
            .map((f) => f.name)
            .toList(),
        'descalificadoPorFaltasGenerales': _faltasGenerales.any(
          (f) => f.selected,
        ),
      ...
      if (e == 'YA_EXISTE') {
        ...
        final pending = (list is List)
            ...
            : <Map<String, dynamic>>[];
        if (docId != null && evalData != null) {
          pending.add({'docId': docId, 'data': evalData});
        }
  ...
  List<_Exhibicion> _buildExhibicionesFS(String rawStyle) {
    ...
    if (s == 'FANCY DRILL' || s == 'SOUNDTRACK') {
      return [_Exhibicion(1), _Exhibicion(2), _Exhibicion(3)];
    }
    return [];
  }
  ...
  List<_ExhibicionMS> _buildExhibicionesMS(String rawStyle) {
    ...
    if (s == 'MILITARY DRILL' || s == 'SILENT DRILL') {
      return [_ExhibicionMS(1), _ExhibicionMS(2), _ExhibicionMS(3)];
    }
    return [];
  }
  ...
  List<_InnovacionF> _buildInnovacionesF(String rawStyle) {
    final s = _styleKey(rawStyle);
    if (s == 'FANCY DRILL') {
      return [_InnovacionF(1), _InnovacionF(2), _InnovacionF(3)];
    }
    return [];
  }
  ...
  List<_InnovacionM> _buildInnovacionesM(String rawStyle) {
    final s = _styleKey(rawStyle);
    if (s == 'MILITARY DRILL') {
      return [_InnovacionM(1), _InnovacionM(2), _InnovacionM(3)];
    }
    return [];
  }
  ...
  List<_InnovacionS> _buildInnovacionesS(String rawStyle) {
    final s = _styleKey(rawStyle);
    if (s == 'SILENT DRILL') {
      return [_InnovacionS(1), _InnovacionS(2), _InnovacionS(3)];
    }
    return [];
  }
  ...
  List<_InnovacionT> _buildInnovacionesT(String rawStyle) {
    final s = _styleKey(rawStyle);
    if (s == 'SOUNDTRACK') {
      return [_InnovacionT(1), _InnovacionT(2), _InnovacionT(3)];
    }
    return [];
  }
  ...
  List<_FaltaItem> _buildFaltasEstiloSoundtrack(String rawStyle) {
    final s = _styleKey(rawStyle);
    if (s == 'SOUNDTRACK') {
      return [_FaltaItem('Plena'), _FaltaItem('Cadencias largas')];
    }
    return [];
  }
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: Text(
                  'Creatividad al ejecutar el pliegue o repliegue',
                  style: const TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.w600,
                  ),
        ...
        children: [
          Row(
            children: [
              ...
              Container(
                ...
                child: Text(
                  '${e.originalidad + e.ejecucion + e.composicion} / 6',
                  style: const TextStyle(fontWeight: FontWeight.w700),
                ),
              ),
            ],
          ...
          Row(
            children: [
              Expanded(
                child: Text(
                  'Originalidad en las combinaciones',
                  style: const TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.w600,
                  ),
          ...
          Row(
            children: [
              Expanded(
                child: Text(
                  'Ejecución novedosa / Creatividad',
                  style: const TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.w600,
                  ),
          ...
          Row(
            children: [
              Expanded(
                child: Text(
                  'Composición de eslogan o cadencias numéricas',
                  style: const TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.w600,
                  ),
        ...
        children: [
          Row(
            children: [
              ...
              Container(
                ...
                child: Text(
                  '${e.originalidad + e.plenas + e.cadencias + e.intervalos + e.contramarcha} / 10',
                  style: const TextStyle(fontWeight: FontWeight.w700),
                ),
              ),
            ],
          ...
          Row(
            children: [
              Expanded(
                child: Text(
                  'Ejecuciones con intervalos (cerrado o medio)',
                  style: const TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.w600,
                  ),
          ...
          Row(
            children: [
              Expanded(
                child: Text(
                  'Uso de contra la marcha en ejecuciones',
                  style: const TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.w600,
                  ),
        ...
        children: [
          Row(
            children: [
              ...
              Container(
                ...
                child: Text(
                  '${e.originalidadBordon + e.intervalos} / 4',
                  style: const TextStyle(fontWeight: FontWeight.w700),
                ),
              ),
            ],
          ...
          Row(
            children: [
              Expanded(
                child: Text(
                  'Originalidad en las combinaciones con el bordón',
                  style: const TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.w600,
                  ),
              ...
              GestureDetector(
                onTap: e.originalidadBordon > 0
                    ? () {
                        setState(() {
                          e.originalidadBordon = (e.originalidadBordon - 1)
                              .clamp(0, 2);
                        });
                      }
                    : null,
        ...
        children: [
          Row(
            children: [
              Expanded(
                child: Text(
                  'Exhibición ${e.index} — Grado de dificultad',
                  style: const TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.w700,
                  ),
          ...
          Row(
            children: [
              Expanded(
                child: Text(
                  'Implementación de pasos en diferentes tiempos',
                  style: const TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.w600,
                  ),
              ...
              GestureDetector(
                onTap: e.tiempos > 0
                    ? () {
                        setState(() {
                          e.tiempos = (e.tiempos - 1).clamp(0, 3);
                        });
                      }
                    : null,
                child: Container(
          ...
          const SizedBox(height: 8),
          TextField(
            controller: e.commentTiempos,
            decoration: InputDecoration(
              labelText: 'Comentario (tiempos)',
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(12),
              ),
            ),
          ...
          Row(
            children: [
              Expanded(
                child: Text(
                  'Grado de dificultad en la deformación',
                  style: const TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.w600,
                  ),
              ...
              Container(
                ...
                child: Text('${e.deformacion} / 3'),
              ),
              const SizedBox(width: 8),
              GestureDetector(
                onTap: e.deformacion > 0
                    ? () {
                        setState(() {
                          e.deformacion = (e.deformacion - 1).clamp(0, 3);
                        });
                      }
                    : null,
                child: Container(
          ...
          const SizedBox(height: 8),
          TextField(
            controller: e.commentDeformacion,
            decoration: InputDecoration(
              labelText: 'Comentario (deformación)',
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(12),
              ),
            ),
        ...
        children: [
          Row(
            children: [
              Expanded(
                child: Text(
                  'Exhibición ${e.index} — Impacto del juez',
                  style: const TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.w700,
                  ),
            ...
            children: [
              ...
              GestureDetector(
                onTap: e.tiempos > 0
                    ? () {
                        setState(() {
                          e.tiempos = (e.tiempos - 1).clamp(0, 2);
                        });
                      }
                    : null,
                child: Container(
            ...
            children: [
              ...
              GestureDetector(
                onTap: e.deformacion > 0
                    ? () {
                        setState(() {
                          e.deformacion = (e.deformacion - 1).clamp(0, 2);
                        });
                      }
                    : null,
                child: Container(
        ...
        children: [
          Row(
            children: [
              Expanded(
                child: Text(
                  'Exhibición ${e.index} — Sincronización con la música',
                  style: const TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.w700,
                  ),
